    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int i)
    {
        ...
        if (fromMessageType.equals("text"))
        {
            ...
            if(fromUserID.equals(messageSenderId)) {
                ...
                messageViewHolder.messageSenderPicture.setVisibility(View.VISIBLE);
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/whatsapp-cf68e.appspot.com/o/Document%20Files%2Ffile.png?alt=media&token=ffedb517-1b7a-4481-baba-5877805a39c2")
            ...
            messageViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(userMessagesList.get(i).getType().equals("pdf") || userMessagesList.get(i).getType().equals("docx")){
                        ...
                        builder.setTitle("Delete this document?");
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int position) {
                                ...
                                if (position == 0){
                                    ...
                                    deleteReceivedMessage(i,messageViewHolder);
                                    Intent intent = new Intent(messageViewHolder.itemView.getContext(),MainActivity.class);
                                    messageViewHolder.itemView.getContext().startActivity(intent);
